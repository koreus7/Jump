...
(function($) {
	...
	me.DefaultLoadingScreen = me.ScreenObject.extend({
		...
		init : function() {
			this.parent(true);
			// melonJS logo
			this.logo1 = new me.Font('century gothic', 32, '#858585', 'middle');
			this.logo2 = new me.Font('century gothic', 32, '#3E6B85', 'middle');
			this.logo2.bold();
		...
		draw : function(context) {
			...
			// measure the logo size
			var logo1_width = this.logo1.measureText(context, "Jump").width;
			...
			this.logo1.draw(context, 'Jump', xpos , ypos);
			xpos += logo1_width;
			this.logo2.draw(context, '!', xpos, ypos);
			
			ypos += this.logo1.measureText(context, "Jump").height / 2;
...
(function($, game) {
	...
	me.TMXLayer = Object.extend({
		...
		getTile : function(x, y) {
			var tile = this.layerData[~~(x / this.tilewidth)][~~(y / this.tileheight)]
			return tile;
		},
